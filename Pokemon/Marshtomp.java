package Pokemon;
import Skill.*;
public class Marshtomp implements ModelPokemon{
    public String name="Marshtomp";
    public int lv=16;
    public int basehp=70;
    public int baseatk=85;
    public int basedef=70;
    public int basespatk=60;
    public int basespdef=70;
    ...
    public Marshtomp(ModelSkill skill1, ModelSkill skill2, ModelSkill skill3, ModelSkill skill4){
        status.setName(name);
