package Pokemon;
import Skill.*;
public class Grovyle implements ModelPokemon{
    public String name="Grovyle";
    public int lv=16;
    public int basehp=50;
    public int baseatk=65;
    public int basedef=45;
    public int basespatk=85;
    public int basespdef=65;
    ...
    public Grovyle(ModelSkill skill1, ModelSkill skill2, ModelSkill skill3, ModelSkill skill4){
        status.setName(name);
