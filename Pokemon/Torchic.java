package Pokemon;
import Skill.*;
public class Torchic implements ModelPokemon{
    public String name="Torchic";
    public int lv=5;
    public int basehp=45;
    public int baseatk=60;
    public int basedef=40;
    public int basespatk=70;
    public int basespdef=50;
    public int basespeed=45;
    ...
    public void showstastu(){
        ...
        public void upSkill(int lv){
            if(lv==10)
                skill2 = new SkillEmber();
            if (lv==16)
                skill3 = new SkillPeck();
            if (lv==25)
                skill4 = new SkillFireSpin();
        ...
        public void evo(int lv){
            if(lv==16){
                this.evocombusken = new Combusken(skill1, skill2, skill3, skill4);
            }
        }
