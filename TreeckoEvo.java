...
import Pokemon.*;
import item.*;
public class TreeckoEvo extends JFrame{
    private Treecko evo;
    private Grovyle pokemon;
	...
	// 		public void run() {
	// 			TreeckoEvo t2 = new TreeckoEvo();
	// 			t2.setVisible(true);;
	// 		}
	// 	});
	// }

    public TreeckoEvo(int money, int numpotion){
        this.money=money;
        ...
        evo = new Treecko();
        evo.status.setLv(16);
        pokemon = new Grovyle(evo.skill1, evo.skill2, evo.skill3, evo.skill4);
        monster = new Poochyenalv20();
        potion = new Potion();
        // panel = new ImagePanel(new ImageIcon("Grovyle.png").getImage());
    ...
    public void makeGUI(){
        ...
        ImagePanel panel = new ImagePanel(new ImageIcon("Combusken.png").getImage());
    	panel.setLayout(null);
        panel.setBounds(50, 150, 600, 500);//x y w h
        this.getContentPane().add(panel);
