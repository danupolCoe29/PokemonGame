...
public class TreeckoGame extends JFrame{
    ...
    public void makeGUI(){
        ...
        ImagePanel panel = new ImagePanel(new ImageIcon("Treecko.png").getImage());
    ...
    public void evo(){
        TreeckoEvo t1 =new TreeckoEvo(money,numPotion);

         setVisible(false);
        gameGUI.setVisible(false);
     
        JOptionPane statusDialog = new JOptionPane();
        String text = "Wowww !!!\n" + pokemon.status.getName() + " Evolve into a Grovyle ";
