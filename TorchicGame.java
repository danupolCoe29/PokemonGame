...
import Pokemon.*;
import item.*;
public class TorchicGame extends JFrame{
    public Torchic pokemon;
	...
	// 		public void run() {
	// 			TorchicGame t2 = new TorchicGame();
	// 			t2.setVisible(true);;
	// 		}
	// 	});
	// }
    ...
    public void makeGUI(){
        ...
        ImagePanel panel = new ImagePanel(new ImageIcon("Torchic.png").getImage());
    ...
    public void evo(){
        TorchicEvo t1 =new TorchicEvo(money,numPotion);

         setVisible(false);
        gameGUI.setVisible(false);
     
        JOptionPane statusDialog = new JOptionPane();
        String text = "Wowww !!!\n" + pokemon.status.getName() + " Evolve into a Combusken ";
