...
import Pokemon.*;
import item.*;
public class TorchicEvo extends JFrame{
    private Treecko evo;
	...
	// 		public void run() {
	// 			TorchicEvo t2 = new TorchicEvo();
	// 			t2.setVisible(true);;
	// 		}
	// 	});
	// }

    public TorchicEvo(int money, int numpotion){
        this.money=money;
    ...
    public void makeGUI(){
        ...
        ImagePanel panel = new ImagePanel(new ImageIcon("Grovyle.png").getImage());
    	panel.setLayout(null);
        panel.setBounds(50, 150, 600, 500);//x y w h
        this.getContentPane().add(panel);
