...
import Pokemon.*;
import item.*;
public class MudkipEvo extends JFrame{
    private Mudkip evo;
    private Marshtomp pokemon;
    private Poochyenalv20 monster;
	...
	// 		public void run() {
	// 			MudkipEvo t2 = new MudkipEvo();
	// 			t2.setVisible(true);;
	// 		}
	// 	});
	// }

    public MudkipEvo(int money, int numpotion){
        this.money=money;
        ...
        evo = new Mudkip();
        evo.status.setLv(16);
        pokemon = new Marshtomp(evo.skill1, evo.skill2, evo.skill3, evo.skill4);
        monster = new Poochyenalv20();
        potion = new Potion();
        // panel = new ImagePanel(new ImageIcon("Marshtomp.png").getImage());
    ...
    public void makeGUI(){
        ...
        ImagePanel panel = new ImagePanel(new ImageIcon("Marshtomp.png").getImage());
    	panel.setLayout(null);
        panel.setBounds(50, 150, 600, 500);//x y w h
        this.getContentPane().add(panel);
